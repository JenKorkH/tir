            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                        <li><a class="dropdown-item" href="{{ route('admin.guns.index') }}">Вся зброя</a></li>
                        <li><a class="dropdown-item" href="{{ route('admin.guns.create') }}">Додати зброю</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item  active" href="{{ route('admin.brands.index') }}">Всі бренди </a></li>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                        <li><a class="dropdown-item active" href="#">Всі інструктори</a></li>
                        <li><a class="dropdown-item" href="#">Додати інструктора</a></li>
                    </ul>
                </div>
                <div class="dropdown">
                    <a class="nav-link text-white dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown">
                    ...
                    @foreach($brands as $brand)
                        ...
                        <tr class="table__col">
                            ...
                            <td style="text-align: right;">
                                <a  href="{{ route('admin.brands.edit', $brand->id) }}" type="button" class="btn btn-warning btn-sm text-white" style="margin-right: 10px; align-items: center;"><img src="/images/edit.png" alt=""> Редагувати</a>
                            </td>
                        </tr>
                        </tbody>
                    @endforeach
